package com.st10461262.imadcalculator2
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnAddToList = findViewById(R.id.btnAddToList)
        btnAddToList.setOnClickListner {
            ...
            intCount = intCount + 1
        }else{            etNumber?.error = "Input Limit reached (10 numbers)"
        }
    }
